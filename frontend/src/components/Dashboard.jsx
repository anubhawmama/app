...
const Dashboard = () => {
  ...
  const menuItems = [
    { icon: Building2, label: 'Dashboard', active: true, path: '/dashboard' },
    { icon: Calendar, label: 'Planning', active: false, path: '/planning' },
    { icon: BarChart3, label: 'Analytics', active: false, path: '/analytics' },
    ...(permissions.canEditSystemMetadata ? [{ icon: Settings, label: 'System Management', active: false, path: '/system-management' }] : []),
    ...(permissions.canSendRequests ? [{ icon: FileText, label: 'Planning Requests', active: false, path: '/planning-requests' }] : []),
    ...(permissions.canAccessPlanning ? [{ icon: Target, label: 'Plan Management', active: false, path: '/plan-management' }] : []),
